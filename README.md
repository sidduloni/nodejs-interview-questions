...
- Request object and Responce object middleware

## S.No 55 Pseudo-class in CSS with an example
**Ans**
Pseudo-classes in CSS are used to define special states or behaviors of elements. 
```css
An example of the `:hover` pseudo-class:
...
**Ans**
Indexing in MongoDB is used to improve query performance. You can create indexes on specific fields in a collection to make queries faster. For example, to create an index on the "email" field in a "users" collection:
```javascript
